                ...
                Ok(Event::new(e.kind).add_attributes(
                    e.attributes
                        ...
                        .map(|a| -> Result<Attribute, Utf8Error> {
                            Ok(match a {
                                cosmrs::tendermint::abci::EventAttribute::V037(ea) => Attribute {
                                    key: ea.key.to_string(),
                                    value: ea.value.to_string(),
                                },
                                cosmrs::tendermint::abci::EventAttribute::V034(ea) => Attribute {
                                    key: std::str::from_utf8(ea.key.as_ref())?.to_string(),
                                    value: std::str::from_utf8(ea.value.as_ref())?.to_string(),
                                },
                            })
                        })
